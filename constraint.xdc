...
## GPIO6
set_property PACKAGE_PIN R15 [get_ports {SCL0}]
set_property IOSTANDARD LVCMOS33 [get_ports SCL0]
## GPIO7
set_property PACKAGE_PIN L14 [get_ports {SDA1}]
set_property IOSTANDARD LVCMOS33 [get_ports SDA1]
## GPIO8
set_property PACKAGE_PIN L15 [get_ports {SCL1}]
set_property IOSTANDARD LVCMOS33 [get_ports SCL1]
## GPIO9
set_property PACKAGE_PIN J13 [get_ports {PWMo}]
set_property IOSTANDARD LVCMOS33 [get_ports PWMo]
## GPIO10
set_property PACKAGE_PIN H14 [get_ports {CLKo}]
